...
const APIGuideDSExtract = ({ ...props }) => {
  return (
    <APIGuideDSExtractStyle {...props}>
      <SubSection>
        <LnbTarget id="basic" text="기본정보">
          <Title level={5} color="grey800" mg="0 0 10px" bold>기본정보</Title>
        </LnbTarget>
        <Text size="middle" color="grey700" mg="0 0 40px">Contextual DS - 추출 요약은 문서의 핵심 내용을 파악해 요약해주는 솔루션입니다.</Text>
    ...
    </APIGuideDSExtractStyle>
  );
};

const APIGuideDSExtractStyle = styled.div`
`;

export default APIGuideDSExtract;